...
size_DOI = 1.5;                 %round(2*lambda/0.75,1); 0.4  %;%0.24; %;          % size of DOI
epsono_r_c = 3+1*1i;               % the constant relative permittivity of the object
Ns = 20;                       % number of RXs
Ni = Ns;                        % number of TXs
...
obj_rad = 0.1;
epsono_r((x-0.4).^2+(y+0.5).^2<=(obj_rad)^2) = epsono_r_c;
%%
